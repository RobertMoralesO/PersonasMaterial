...
$foto = "http://54.175.250.214/fotos/".$INPUT['idfoto'].".jpg";


$sql= "INSERT INTO personas(uuid, urlFoto, cedula,nombre,apellido,idfoto) values (?,?,?,?,?,?)";

$stmt = $db->prepare($sql);
$stmt->bindParam(1,$INPUT['id']);
$stmt->bindParam(2,$foto);
$stmt->bindParam(3,$INPUT['cedula']);
$stmt->bindParam(4,$INPUT['nombre']);
$stmt->bindParam(5,$INPUT['apellido']);
